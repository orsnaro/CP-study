...
//prob: https://www.hackerrank.com/challenges/compare-the-triplets/problem?isFullScreen=true
...
class Result
{
    ...
    public static List<int> compareTriplets(List<int> a, List<int> b)
    {
        ...
        for (int i = 0; i < 3; i++){
            if (Convert.ToInt32(a[i]) > Convert.ToInt32(b[i])) ans[0]++;
            else if (Convert.ToInt32(a[i]) < Convert.ToInt32(b[i])) ans[1]++;
        }
