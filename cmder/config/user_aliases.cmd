...
bmporg= cd /d c:\%USERNAME%\OmarPc\repo_CHROMA_BMP_proj  
msporg=cd /d c:\%USERNAME%\OmarPc\repo_MSP_ML_study  
interporg=cd /d c:\%USERNAME%\OmarPc\repo_CRAFTING_INTERPRETERS_study  
