...
cporg=cd /d C:\Users\omar4\repo_CPP_COMP_study  
bmporg=cd c:\users\omar4\repo_chroma_bmp_proj\  
org2=cd c:\Users\omar4\repo_CRAFTING_INTERPRETERS_study\  
msporg=cd c:\Users\omar4\repo_MSP_ML_study  
shorts=start C:\Users\omar4\repo_CPP_COMP_study\shortcuts.txt  
allgitall=cd c:\Users\omar4\repo_MSP_ML_study $t git add --all $t git commit -m "# $*" $t git push $t cd c:\Users\omar4\repo_CPP_COMP_study $t git add --all $t git commit -m "# $*" $t git push $t cd c:\Users\omar4\repo_CHROMA_BMP_proj $t git add --all $t git commit -m "# $*" $t git push  
comp=cd /d c:\users\omar4\repo_CPP_COMP_study $t start  https://codeforces.com/contests $t code cp.cpp $t start  C:\Users\omar4\AppData\Local\Programs\pomotroid\Pomotroid $t start  https://commons.wikimedia.org/wiki/File:Ascii-proper-color.svg#/media/File:Ascii-proper-color.svg $t calcshift+ctrl+/ (jmp to matching bracket  
